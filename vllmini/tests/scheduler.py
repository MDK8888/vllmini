...
def test_scheduler():
    ...
    scheduler = Scheduler(paged_attention, max_length)
    ...
    print("\nTest 3: Multiple sequence handling")
    seq_id_2, seq_id_3 = 2, 3
    ...
    for i in range(max_iterations):
        ...
        if scheduler.queue.empty() and scheduler.preempted_sequences.empty():
